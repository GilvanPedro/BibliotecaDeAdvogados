...
public class HistoricoLeituraRepository {
    ...
    public List<HistoricoDTO> listar() {
        ...
        try (Connection conn = ConexaoBanco.getConnection();
            ...
            while (rs.next()) {
                historicos.add(new HistoricoDTO(
                        rs.getInt("id"),
    ...
    public HistoricoDTO buscarPorEmprestimoId(int emprestimoId) {
    ...
    public void atualizar(Emprestimo emprestimo, StatusLeitura status) {
        ...
        HistoricoLeitura historico = historicoLeituraService.buscarHistoricoPorEmprestimoId(emprestimo.getId());
